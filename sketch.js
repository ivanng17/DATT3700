...
function showQuestion() {
  ...
  fill(255);
  noStroke();
  rect(width / 4, height - 32.5, 90 + 90 * currentQuestion, 15, 25);
  ...
  for (let i = 0; i < 4; i++) {
    ...
    if (i == 2){
      ...
      imageMode(CENTER);
      tint(255, 127);
      image(freedomImage, x/2, y, 50, 30);
    ...
    if (i == 3){
      ...
      imageMode(CENTER);
      tint(255, 127);
      image(generosityImage, x/2, y, 50, 50);
